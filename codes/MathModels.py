...
class DR2_cross_all_pprior:
    ...
    parameter_defaults.loc['KsysDES_QSO'] = [1, [0,10,'gauss'], r'$K_{\mathrm{DES}^\mathrm{QSO}}$', 1, r'\%']
    parameter_defaults.loc['Kregr'] = [0, [0,0.1,'gauss'], r'$K_{\mathrm{regr}}$', 1, r'\%']
    parameter_defaults.loc['pg_LRG'] = [1, [1,0.1,'gauss'], r'$p_{\mathrm{g}^\mathrm{LRG}}$', 1, r'\%']
    parameter_defaults.loc['pg_QSO'] = [1, [1.6,0.1,'gauss'], r'$p_{\mathrm{g}^\mathrm{QSO}}$', 1, r'\%']
    parameter_defaults.loc['ppng_LRG'] = [1, [1,0.1,'gauss'], r'$p_{\mathrm{PNG}^\mathrm{LRG}}$', 1, r'\%']
    parameter_defaults.loc['ppng_QSO'] = [0, [1.6,0.1,'gauss'], r'$p_{\mathrm{PNG}^\mathrm{QSO}}$', 1, r'\%']
    ...
    def xi_modded_base_pars(mod, params):
        ...
        r_fac_c1[mod.term_masks['LRG_ell0']] = (((b0g_LRG/Dz_g['LRG_ell0']) + f_g['LRG_ell0']/3)*\
                                                ((b0g_LRG/Dz_g['LRG_ell0'])-pg_LRG)*((mod.Om_m0_g*mod.H0**2)/Dz_g['LRG_ell0']))/\
                                                (((b0g_png_LRG/Dz_png['LRG_ell0']) + f_png['LRG_ell0']/3)*\
                                                 ((b0g_png_LRG/Dz_png['LRG_ell0'])-ppng_LRG)*\
                                                     ((mod.Om_m0_png*mod.H0_png**2)/Dz_png['LRG_ell0']))
        r_fac_c1[mod.term_masks['LRGxQSO_ell0']] = ((((b0g_LRG/Dz_g['LRGxQSO_ell0'])+f_g['LRGxQSO_ell0']/3)*\
                                                     ((b0g_QSO/Dz_g['LRGxQSO_ell0'])-pg_QSO)+\
                                            ((b0g_QSO/Dz_g['LRGxQSO_ell0'])+f_g['LRGxQSO_ell0']/3)*\
                                                     ((b0g_LRG/Dz_g['LRGxQSO_ell0'])-pg_LRG))*\
                                            ((mod.Om_m0_g*mod.H0**2)/Dz_g['LRGxQSO_ell0']) )/\
                                            ((((b0g_png_LRG/Dz_png['LRGxQSO_ell0']) + f_png['LRGxQSO_ell0']/3)*\
                                              ((b0g_png_QSO/Dz_png['LRGxQSO_ell0'])-ppng_QSO) +\
                                             ((b0g_png_QSO/Dz_png['LRGxQSO_ell0']) + f_png['LRGxQSO_ell0']/3)*\
                                              ((b0g_png_LRG/Dz_png['LRGxQSO_ell0'])-ppng_LRG))*\
                                            ((mod.Om_m0_png*mod.H0_png**2)/Dz_png['LRGxQSO_ell0']))
        r_fac_c1[mod.term_masks['QSO_ell0']] = (((b0g_QSO/Dz_g['QSO_ell0']) + f_g['QSO_ell0']/3)*\
                                                ((b0g_QSO/Dz_g['QSO_ell0'])-pg_QSO)*((mod.Om_m0_g*mod.H0**2)/Dz_g['QSO_ell0']))/\
                                        (((b0g_png_QSO/Dz_png['QSO_ell0']) + f_png['QSO_ell0']/3)*\
                                         ((b0g_png_QSO/Dz_png['QSO_ell0'])-ppng_QSO)*\
                                             ((mod.Om_m0_png*mod.H0_png**2)/Dz_png['QSO_ell0']))

        r_fac_c2[mod.term_masks['LRG_ell0']] = ((((b0g_LRG/Dz_g['LRG_ell0'])-pg_LRG)*((mod.Om_m0_g*mod.H0**2)/Dz_g['LRG_ell0']))**2)/\
                                                ((((b0g_png_LRG/Dz_png['LRG_ell0'])-ppng_LRG)*\
                                                  ((mod.Om_m0_png*mod.H0_png**2)/Dz_png['LRG_ell0']))**2)
        r_fac_c2[mod.term_masks['LRGxQSO_ell0']] = (((b0g_LRG/Dz_g['LRGxQSO_ell0'])-pg_LRG)*\
                                                    ((b0g_QSO/Dz_g['LRGxQSO_ell0'])-pg_QSO)*\
                                                    ((mod.Om_m0_g*mod.H0**2)/Dz_g['LRGxQSO_ell0'])**2)/\
                                                    (((b0g_png_LRG/Dz_png['LRGxQSO_ell0'])-ppng_LRG)*\
                                                     ((b0g_png_QSO/Dz_png['LRGxQSO_ell0'])-ppng_QSO)*\
                                                     ((mod.Om_m0_png*mod.H0_png**2)/Dz_png['LRGxQSO_ell0'])**2)
        r_fac_c2[mod.term_masks['QSO_ell0']] = ((((b0g_QSO/Dz_g['QSO_ell0'])-pg_QSO)*\
                                                 ((mod.Om_m0_g*mod.H0**2)/Dz_g['QSO_ell0']))**2)/\
                                                ((((b0g_png_QSO/Dz_png['QSO_ell0'])-ppng_QSO)*\
                                                  ((mod.Om_m0_png*mod.H0_png**2)/Dz_png['QSO_ell0']))**2)

        r_fac_c1[mod.term_masks['LRG_ell2']] = (f_g['LRG_ell2']*((b0g_LRG/Dz_g['LRG_ell2'])-pg_LRG)*\
                                                ((mod.Om_m0_g*mod.H0**2)/Dz_g['LRG_ell2']))/\
                                                (f_png['LRG_ell2']*((b0g_png_LRG/Dz_png['LRG_ell2'])-ppng_LRG)*\
                                                 ((mod.Om_m0_png*mod.H0_png**2)/Dz_png['LRG_ell2']))
        r_fac_c1[mod.term_masks['LRGxQSO_ell2']] = (f_g['LRGxQSO_ell2']*(((b0g_LRG/Dz_g['LRGxQSO_ell2'])-pg_LRG)+\
                                                                         ((b0g_QSO/Dz_g['LRGxQSO_ell2'])-pg_QSO))*\
                                                    ((mod.Om_m0_g*mod.H0**2)/Dz_g['LRGxQSO_ell2']))/\
                                                (f_png['LRGxQSO_ell2']*(((b0g_png_LRG/Dz_png['LRGxQSO_ell2'])-ppng_LRG)+\
                                                                        ((b0g_png_QSO/Dz_png['LRGxQSO_ell2'])-ppng_QSO))*\
                                                 ((mod.Om_m0_png*mod.H0_png**2)/Dz_png['LRGxQSO_ell2']))
        r_fac_c1[mod.term_masks['QSO_ell2']] = (f_g['QSO_ell2']*((b0g_QSO/Dz_g['QSO_ell2'])-pg_QSO)*\
                                                ((mod.Om_m0_g*mod.H0**2)/Dz_g['QSO_ell2']))/\
                                                (f_png['QSO_ell2']*((b0g_png_QSO/Dz_png['QSO_ell2'])-ppng_QSO)*\
                                                 ((mod.Om_m0_png*mod.H0_png**2)/Dz_png['QSO_ell2']))
        #################################    
        fid_term = r_fac_fid*(mod.masked['xi_fid'])
        PNG_term = r_fac_c1*mod.masked['c1']*fNL + r_fac_c2*mod.masked['c2']*(fNL**2)
